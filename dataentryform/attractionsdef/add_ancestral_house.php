...
<div class="form-container">
    ...
    <h2>Add New Ancestral House</h2>
    <form method="POST" enctype="multipart/form-data">
        <label><i class="fas fa-home"></i> Title:</label>
...
if (isset($_POST['submit'])) {
    ...
    $stmt = $conn->prepare("INSERT INTO ancestral_house (title, description, location, img, latitude, longitude) VALUES (?, ?, ?, ?, ?, ?)");
