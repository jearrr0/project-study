...
<html>
<head>
    <title>Add Natural Tourist Site</title>
...
<div class="form-container">
    ...
    <h2>Add New Natural Tourist Site</h2>
    <form method="POST" enctype="multipart/form-data">
        <label><i class="fas fa-tree"></i> Site Name:</label>
...
<div class="popup" id="popup">
    <p>Natural tourist site added successfully!</p>
...
if (isset($_POST['submit'])) {
    ...
    $stmt = $conn->prepare("INSERT INTO natural_tourist_sites (title, description, location, img, latitude, longitude) VALUES (?, ?, ?, ?, ?, ?)");
