...
<html>
<head>
    <title>Add Recreational Facility</title>
...
<div class="form-container">
    ...
    <h2>Add New Recreational Facility</h2>
    <form method="POST" enctype="multipart/form-data">
        <label><i class="fas fa-building"></i> Facility Name:</label>
        <input type="text" name="title" required>

        <label><i class="fas fa-align-left"></i> Facility Description:</label>
        <textarea name="description" rows="4" required></textarea>

        <label><i class="fas fa-map-marker-alt"></i> Facility Location:</label>
        ...
        <label><i class="fas fa-image"></i> Facility Image:</label>
...
<div class="popup" id="popup">
    <p>Recreational facility added successfully!</p>
...
if (isset($_POST['submit'])) {
    ...
    $stmt = $conn->prepare("INSERT INTO recreational_facilities (title, description, location, img, latitude, longitude) VALUES (?, ?, ?, ?, ?, ?)");
