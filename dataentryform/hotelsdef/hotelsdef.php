...
<div class="form-container">
    ...
    <form method="POST" enctype="multipart/form-data">
        ...
        <textarea name="nearby_places" rows="3"></textarea>

        <label>Amenities and Facilities:</label>
        <textarea name="amenities_facilities" rows="3"></textarea>
        ...
        <label>Promo:</label>
        <textarea name="promo" rows="3"></textarea>
