...
<body>
    ...
    <div class="hero" style="background-image: url('../../uploads/home/image-2-1024x724.jpg');">
        <div class="hero-content">
            ...
            <p>Discover the recreational facilities of Candon City.</p>
        </div>
    </div>
    <main>
    ...
    <div class="content">
        <?php
        $sql = "SELECT * FROM recreational_facilities";
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                ...
                foreach ($images as $index => $image) {
                    ...
                    echo '<img src="' . $image . '" class="d-block w-100" alt="Facility Image">';
                    echo '</div>';
                }
                ...
                echo '<a href="recreational-facility-details.php?id=' . $row['id'] . '" class="btn btn-secondary">View More</a>';
                echo '</div>';

                echo '</div>'; // End of tourist-site-item
            }
        } else {
            echo '<p>No recreational facilities found.</p>';
        }
        ?>
    </div>
</section>
    ...
    <script src="recreational-facilities.js"></script>
