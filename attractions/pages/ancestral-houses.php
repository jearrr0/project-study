...
<head>
    ...
    <link rel="stylesheet" href="ancestral-houses.css">
...
<body>
    ...
    <div class="content">
        ...
        // Fetch Ancestral Houses Data
        $sql = "SELECT * FROM ancestral_houses"; 
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                ...
                foreach ($images as $index => $image) {
                    ...
                    echo '<img src="' . $image . '" class="d-block w-100" alt="Ancestral House Image">';
                    echo '</div>';
                }
                ...
                echo '<a href="ancestral-details.php?id=' . $row['id'] . '" class="btn btn-secondary">View More</a>';
                echo '</div>';

                echo '</div>'; // End of tourist-site-item
            }
        } else {
            echo '<p>No ancestral houses found.</p>';
        }
