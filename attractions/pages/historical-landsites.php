...
<html>
<head>
    <title>Historical Landsites - CandonXplore</title>
    <meta charset="UTF-8">
...
<body>
    ...
    <div class="content">
        ...
        // Fetch Historical Landmarks Data
        $sql = "SELECT * FROM historical_landsites";
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                ...
                foreach ($images as $index => $image) {
                    ...
                    echo '<img src="' . $image . '" class="d-block w-100" alt="Historical Landmark Image">';
                    echo '</div>';
                }
                ...
                echo '<a href="historical-details.php?id=' . $row['id'] . '" class="btn btn-secondary">View More</a>';
                echo '</div>';

                echo '</div>'; // End of tourist-site-item
            }
        } else {
            echo '<p>No historical landmarks found.</p>';
        }
