...
$siteQuery = "SELECT id, title, description, img, latitude, longitude, location FROM livelihood ORDER BY title ASC"; // Updated table
$siteResult = $conn->query($siteQuery);
?>
<!DOCTYPE html>
<html lang="en">
<head>
    <title>Livelihoods in Candon City - CandonXplore</title>
    <meta charset="UTF-8">
...
<nav class="navbar bg-body-tertiary fixed-top">
            ...
            <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
                ...
                <div class="offcanvas-body">
                    <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="/project-study/main/home.php">Home</a>
                        </li>
    ...
    <div class="hero" style="background-image: url('/project-study/uploads/home/livelihoods-banner.jpg');">
        <div class="hero-content">
            <h1>Discover Livelihoods in Candon City</h1>
            <p>Explore the vibrant industries and crafts that sustain the local community! 🛠️🌾</p>
        </div>
    </div>
    ...
    <div class="container-fluid mt-4">
        <div class="where-to-stay">
            <h2>Livelihoods in Candon City</h2>
            <p>Learn about the industries and crafts that define the city's economy and culture.</p>
        </div>
    </div>
