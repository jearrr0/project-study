...
if ($hotelId > 0) {
    // Fetch ancestral house details
    $sql = "SELECT id, title, description, location, img, latitude, longitude FROM ancestral_house WHERE id = ?";
    ...
    if ($result->num_rows > 0) {
        ...
        echo "<p>Ancestral house not found.</p>";
        exit;
    }
} else {
    echo "<p>Invalid ancestral house ID.</p>";
    exit;
}
...
<div class="container mt-5">
    <div class="card shadow-lg">
        <div class="card-body text-center">
            <div class="main-image" style="background-image: url('<?php echo $hotel['img']; ?>'); height: 300px; background-size: cover; background-position: center;"></div>
            <h1 class="card-title mt-4">
                <i class="bi bi-tree"></i> <?php echo htmlspecialchars($hotel['title']); ?>
            </h1>
            ...
            <p><i class="bi bi-compass"></i> <strong>Coordinates:</strong> Lat: <?php echo htmlspecialchars($hotel['latitude']); ?>, Lng: <?php echo htmlspecialchars($hotel['longitude']); ?></p>
            <div class="text-center mt-4">
                <a href="https://maps.google.com/?q=<?php echo $hotel['latitude']; ?>,<?php echo $hotel['longitude']; ?>" target="_blank" class="btn btn-success">
                    <i class="bi bi-geo-alt"></i> View on Map
                </a>
                <a href="details.php?id=<?php echo $hotel['id']; ?>" class="btn btn-primary">
